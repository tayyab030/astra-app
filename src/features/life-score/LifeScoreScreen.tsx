...
const colorMap = {
  blue: { icon: colors.cyan400, border: 'rgba(6, 182, 212, 0.35)' },
  green: { icon: colors.emerald500, border: 'rgba(16, 185, 129, 0.35)' },
  yellow: { icon: colors.amber200, border: 'rgba(251, 191, 36, 0.35)' },
  purple: { icon: colors.purple500, border: 'rgba(168, 85, 247, 0.35)' },
} as const;
